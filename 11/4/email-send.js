...
$w.onReady(async function () {
    ...
    $w("#saveUpdateButton").onClick(async () => {
        try {
            ...
            const netItem = await wixData.get("NetsCollection", updatedBooking.selectedNet);
            const machineItem = await wixData.get("BowlingMachinesCollection", updatedBooking.selectedMachine);
            const coachItem = await wixData.get("CoachesCollection", updatedBooking.selectedCoach);
